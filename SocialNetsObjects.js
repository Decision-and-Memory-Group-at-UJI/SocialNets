...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'party1/object/1.png', 'path': 'party1/object/1.png'},
    {'name': 'party1/object/2.png', 'path': 'party1/object/2.png'},
    {'name': 'party1/object/3.png', 'path': 'party1/object/3.png'},
    {'name': 'party1/object/4.png', 'path': 'party1/object/4.png'},
    {'name': 'party1/object/5.png', 'path': 'party1/object/5.png'},
    ...
    {'name': 'party2/object/1.png', 'path': 'party2/object/1.png'},
    {'name': 'party2/object/2.png', 'path': 'party2/object/2.png'},
    {'name': 'party2/object/3.png', 'path': 'party2/object/3.png'},
    {'name': 'party2/object/4.png', 'path': 'party2/object/4.png'},
    {'name': 'party2/object/5.png', 'path': 'party2/object/5.png'},
...
//    {'name': 'party3/socgroups/5/2.jpg', 'path': 'party3/socgroups/5/2.jpg'},
    ...
    {'name': 'exampleStim/object/1.png', 'path': 'exampleStim/object/1.png'},
    {'name': 'exampleStim/object/2.png', 'path': 'exampleStim/object/2.png'},
    {'name': 'exampleStim/object/3.png', 'path': 'exampleStim/object/3.png'},
    {'name': 'exampleStim/object/4.png', 'path': 'exampleStim/object/4.png'},
    {'name': 'exampleStim/object/5.png', 'path': 'exampleStim/object/5.png'},
...
flowScheduler.add(setText,"Friends from a robotics club (BLUE) needed to buy hardhats (RED) at the shop on the beach (PURPLE) to help build a house (GREEN)","ExB");
flowScheduler.add(routText,"ExB");
flowScheduler.add(routCbeg,3,"Ex");
flowScheduler.add(setText, "Given the stories you created and the set of assignment options, you will realize the hardhat should be ranked first as a tool a contractor would use, and perhaps second for use by an architect.\n  You will also rank the other objects for their purposes using the stories you create with their activity, location, and group images.")
flowScheduler.add(routText,"ExC");
for (let j = parties; j != 0; j--){
    flowScheduler.add(setText,"You'll now view sets of 3 images comprising locations, groups and activities corresponding to an object. When viewing the 3 images, please imagine how the object would be used for a given activity in the displayed location with the presented group of people. Please try to remember these stories that you imagine. You will later need to accurately assign specific purposes to the objects.");
    flowScheduler.add(routText);
    ...
    flowScheduler.add(setText,"Based on the set of images you have just seen for each object, please rank which would be the first and second likely purpose for the object. To rank the purpose of the object, you'll need to click on the photo of the object and drop it to the rank placeholder for a possible purpose.");
    flowScheduler.add(routText);
    flowScheduler.add(setText,"Please rank them as quickly and accurately as possible. You can always overwrite an assigned rank for a purpose by dragging an object from the right column to the ranking. Also, note that objects can be ranked first or second only once.")
    flowScheduler.add(routText);
    flowScheduler.add(routCbeg,j);
    flowScheduler.add(routC);
    flowScheduler.add(routCConfbeg);
    flowScheduler.add(routCConf);
    flowScheduler.add(setText,"You'll now view a series of reference images. You will need to choose which of the two images at the bottom left and right of the screen was previously paired with a reference image.");
    flowScheduler.add(routText);
	flowScheduler.add(setText, "Please answer as quickly and accurately as possible by either pressing the LEFT ARROW or RIGHT ARROW on the keyboard.");
    flowScheduler.add(routText);
...
async function routBbeg(time,nParty){
    ...
    let onetofive = shuffler([...Array(5).keys()].map((k)=>(k+1)))
    people = onetofive.map((k)=>party+"/object/"+k+".png")
    seen = [...Array(people.length).keys()].map((k) => 0);
    situation = onetofive.map((s)=>party+"/socialSit/"+(s));
...
async function routBExbeg(){
    ...
    experson = "exampleStim/object/1.png";
...
async function routCbeg(nParty,Ex){
    ...
    if (typeof Ex !== 'undefined'){
        people = [...Array(5).keys()].map((i)=>"exampleStim/object/"+(i+1)+".png");
        tasks = tasksAll[3]
    }
    let onetofive = shuffler([...Array(5).keys()])
    for (let i = 0; i < people.length; i++){
        let p = people[i];
        pStim[i] = new visual.ImageStim({win:psychoJS.window,image:p,name:"Person " + i,pos:Cpim_positions[onetofive[i]],size:[0.1,0.1],color:'white'});
